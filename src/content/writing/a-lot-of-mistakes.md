...
Six months later, my life looks vastly different. I'd just wrapped up an AI research program at the [New Turing Institute](https://newturing.ai/) (NTI) by Dr. Thang Luong (Google DeepMind), and I'm about to start work as an AI Engineer. But the path wasn't linear. Along the way, I tried on more hats than I ever expected: tutor, marketing associate, and even a hotel receptionist.
...
I applied this lesson when building [NeurIPS 2025 Map](https://neurips-2025.com/) to explore AI research papers.
...
During my years at UofT, one of the people I learned the most from was [Dr. Kennedy Obina Idu](https://sites.google.com/view/kennedyidu), my Multivariable Calculus instructor. Beyond being an exceptional educator, he is one of the wisest people I know.
...
More recently, I stopped calculating and started doing. I built the [NeurIPS 2025 Map](https://neurips-2025.com/) out of my own frustration with navigating research papers. When I read a research paper I found interesting, I re-implemented the [code](https://github.com/huyxdang/RLVR-Decomposed-Implementation) and cold-messaged the author, a researcher at Thinking Machines, which led to feedback from the team.
